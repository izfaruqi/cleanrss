...
type cleanerHTTPChiHandler struct {
	u domain.CleanerUsecase
}

func NewCleanerHTTPChiHandler(u domain.CleanerUsecase) http.Handler {
	handler := cleanerHTTPChiHandler{u: u}
...
func (h cleanerHTTPChiHandler) cleanPage(w http.ResponseWriter, r *http.Request) {
...
func (h cleanerHTTPChiHandler) getAll(w http.ResponseWriter, r *http.Request) {
...
func (h cleanerHTTPChiHandler) getById(w http.ResponseWriter, r *http.Request) {
...
func (h cleanerHTTPChiHandler) insert(w http.ResponseWriter, r *http.Request) {
...
func (h cleanerHTTPChiHandler) update(w http.ResponseWriter, r *http.Request) {
	id, err := strconv.ParseInt(chi.URLParam(r, "id"), 10, 64)
	if err != nil {
...
func (h cleanerHTTPChiHandler) delete(w http.ResponseWriter, r *http.Request) {
	id, err := strconv.ParseInt(chi.URLParam(r, "id"), 10, 64)
	if err != nil {
		utils_http.WriteErrorResponse(w, http.StatusBadRequest, errors.New("id is invalid"))
		return
