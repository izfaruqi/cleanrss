...
func NewProviderHTTPHandler(u domain.ProviderUsecase) http.Handler {
...
func (h providerHTTPHandler) getAll(w http.ResponseWriter, r *http.Request) {
...
func (h providerHTTPHandler) getById(w http.ResponseWriter, r *http.Request) {
...
func (h providerHTTPHandler) insert(w http.ResponseWriter, r *http.Request) {
...
func (h providerHTTPHandler) update(w http.ResponseWriter, r *http.Request) {
	id, err := strconv.ParseInt(chi.URLParam(r, "id"), 10, 64)
	if err != nil {
		utils_http.WriteErrorResponse(w, http.StatusBadRequest, errors.New("id is invalid"))
		return
...
func (h providerHTTPHandler) delete(w http.ResponseWriter, r *http.Request) {
	id, err := strconv.ParseInt(chi.URLParam(r, "id"), 10, 64)
	if err != nil {
		utils_http.WriteErrorResponse(w, http.StatusBadRequest, errors.New("id is invalid"))
		return
